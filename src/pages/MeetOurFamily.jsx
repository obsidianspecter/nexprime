...
function MeetOurFamily() {
  ...
  const teamMembers = [
    ...
    // Adding Harisudhan and Anvin to the team section as well
    {
      id: "harisudhan",
      name: 'Harisudhan M',
  ...
  const PersonCard = ({ person, category }) => (
    <div className="text-center p-4 transition-all duration-300 hover:scale-105 cursor-pointer" onClick={() => handleProfileClick(person.id, category)}>
  ...
  return (
    <div className="w-screen min-h-screen m-0 p-0 font-inter bg-[#0E0B1E] text-white">
      <div className="pt-24 px-8">
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center">
            {founders.map((founder, index) => (
              <div key={index}>
                <PersonCard person={founder} category="founder" />
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Co-Founders Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">Co-Founders</h2>
